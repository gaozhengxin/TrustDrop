...
// lib/@chainlink/contracts@1.5.0/src/v0.8/functions/v1_0_0/interfaces/IFunctionsClient.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/functions/v1_0_0/libraries/FunctionsResponse.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/shared/interfaces/IOwnable.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/vendor/@ensdomains/buffer/v0.1.0/Buffer.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/functions/v1_0_0/interfaces/IFunctionsRouter.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/shared/access/ConfirmedOwnerWithProposal.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/vendor/solidity-cborutils/v2.0.0/CBOR.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/functions/v1_0_0/libraries/FunctionsRequest.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/shared/access/ConfirmedOwner.sol
...
// lib/@chainlink/contracts@1.5.0/src/v0.8/functions/v1_0_0/FunctionsClient.sol
...
// src/oracle/FunctionsConsumer_Walrus.sol
...
contract WalrusFunctionsConsumer is FunctionsClient, ConfirmedOwner {
    ...
    string source = 
        "const initDate=new Date('2025-12-16T00:00:00Z');const initEpoch=20;const epochLength=1209600;"
        "const encodeResponse=(s,t)=>{const res=new Uint8Array(64);const v=new DataView(res.buffer);v.setUint32(28,s);v.setUint32(60,t);return res;};"
        ...
        "try{"
        "  const res=await Functions.makeHttpRequest({url:`https://api.blockberry.one/walrus-mainnet/v1/blobs/${base64}`,headers:{'accept':'*/*','x-api-key':apiKey},timeout:5000});"
